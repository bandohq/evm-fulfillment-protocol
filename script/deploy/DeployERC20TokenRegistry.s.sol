...
import {ERC20TokenRegistryV1} from "../../contracts/periphery/registry/ERC20TokenRegistryV1.sol";
...
contract DeployERC20TokenRegistry is ScriptBase {
  ...
  function run() public returns (
        ...
        bytes memory implementationBytecode = type(ERC20TokenRegistryV1).creationCode;
        implementation = Create2.deploy(0, salt, implementationBytecode);
        // 2. Prepare initialization data
        bytes memory initData = abi.encodeCall(
          ERC20TokenRegistryV1.initialize,
          (deployer)
        );
        ...
        ERC20TokenRegistryV1 proxyContract = ERC20TokenRegistryV1(deployed);
